...
namespace Lean.Touch
{
    ...
    public class LeanRotateCustomAxis : MonoBehaviour
    {
        ...
        protected virtual void Update()
        {
            ...
            //var twistDegrees = LeanGesture.GetScaledDistance(fingers);
            var twistDegrees = LeanGesture.GetTwistRadians(fingers, transform.position,
                LeanGesture.GetLastScreenCenter(fingers));
            var touch = new LeanFingerSwipe();
